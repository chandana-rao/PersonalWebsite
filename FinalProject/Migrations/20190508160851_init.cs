        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    university = table.Column<string>(maxLength: 250, nullable: false),
                    year = table.Column<string>(maxLength: 250, nullable: false),
                    major = table.Column<string>(maxLength: 250, nullable: false),
                    coursework = table.Column<string>(nullable: true),
                    degreeType = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_academics", x => x.EId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    technologies = table.Column<string>(maxLength: 250, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_experiences", x => x.PEId);
                });
